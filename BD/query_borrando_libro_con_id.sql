...
UPDATE libros SET descripcion = "El alquimista es una novela sobre Santiago, un joven pastor andaluz que emprende un viaje en busca de un tesoro soñado en las pirámides de Egipto. En el camino, descubre que el verdadero tesoro es seguir su “Leyenda Personal” y escuchar a su corazón." WHERE id = 7;
